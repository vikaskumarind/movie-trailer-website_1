...
movies = [toy_story, lawrense_arabia, godfather,
          gunsofnavarone, gravity, starwars, lordoftherings]

# Invoke the method in fresh tomatoes to display the html page
